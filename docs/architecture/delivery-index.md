...
| Item | Status / link |
|------|----------------|
| Vídeo ≤15 min (YouTube/Vimeo) | _preencher após gravação_ |
| PDF Portal (este índice + links acima) | _gerar a partir desta página_ |
| Confirmação `soat-architecture` nos 4 repos | _pendente aceite_ |
